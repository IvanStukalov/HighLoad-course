...
Все таблицы (за исключением `user_session`) положим в MongoDB. Данные в ней хранятся не в реляционном формате, а в виде документов в формате json, что делает её крайне гибкой и упрощает адаптацию к требованиям.
...
В роли основной БД выступает AMongoDB. Данные в ней хранятся не в реляционном формате, а в виде документов в формате json, что делает её крайне гибкой и упрощает адаптацию к требованиям.
