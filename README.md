...
| 2  | Авторизация                     | Запись |   6,8    |   588 тыс    |
...
```
Имя, Фамилия, Никнейм: все по 32 символа, каждый по байту. 
Пароль: в захэшированном виде 32 байта;
Описание: 300 символов по байту каждый;
Аватарка: 50 Кбайт;

Итого: 3*32 + 32 + 300 + 50*1024 = 50,4 Кб
```
...
Голосовое сообщение: 16 + 200*10^3 + 4 + 4 + 16 = 200 Кб
Сообщение с вложением: 140 + 5*10^6 = 5 Мб
```
...
Пост с вложением: 124 + 5*10^6 = 5 Мб
```
...
```
Общий объем хранилица: 500*10^6 * 50,4*10^3 = 25,2 Тб
```
...
Общий объем памяти за все время: 2,1 * 365 * 17 = 13 Пб
```
...
Общий объем памяти в день: 15*10^9 * 1% * 200*10^3 = 30 Тб
Общий объем памяти за все время: 30 * 365 * 7 = 77 Пб
```
...
Общий объем памяти за все время: 380 * 365 * 17 = 2400 Пб
```
...
Общий объем памяти за все время: 2,6 * 365 * 17 = 16 Тб
```
...
Общий объем памяти за все время: 19 * 365 * 17 = 119 Пб
```
...
| № | Действие                        | Объем памяти за все время |
|:-:|---------------------------------|:-------------------------:|
| 1 | Профили пользователей           |          25,2 Тб          |
| 2 | Создание текстовых сообщений    |           13 Пб           |
| 3 | Создание голосовых сообщений    |           77 Пб           |
| 4 | Создание сообщений с вложениями |          2400 Пб          |
| 5 | Создание комментариев           |           16 Тб           |
| 6 | Создание постов                 |          119 Пб           |
| 7 | Создание диалога                |           3 Тб            |
...
Для получения пикового трафика умножим все показатели в 2 раза

| №  | Действие                        | Средний трафик | Пиковый трафик | Суммарный суточный трафик |
|:--:|---------------------------------|:--------------:|:--------------:|:-------------------------:|
| 1  | Регистрация                     |   40,3 Кб/с    |   80,6 Кб/с    |        3,5 Гб/сут         |
| 2  | Авторизация                     |    343 Кб/с    |    686 Кб/с    |         30 Гб/сут         |
| 3  | Изменение профиля               |    171 Кб/с    |    342 Кб/с    |         15 Гб/сут         |
| 4  | Поиск людей                     |    4,5 Кб/с    |     9 Кб/с     |        390 Мб/сут         |
| 5  | Добавление в друзья             |    9,6 б/с     |    19,2 б/с    |        830 Кб/cут         |
| 6  | Создание текстовых сообщений    |    24 Мб/с     |    48 Мб/с     |        2,1 Тб/сут         |
| 7  | Создание голосовых сообщений    |    348 Мб/с    |    696 Мб/с    |         30 Тб/сут         |
| 8  | Создание сообщений с вложениями |    44 Гб/с     |    88 Гб/с     |        3,8 Пб/сут         |
| 9  | Редактирование сообщения        |    2,4 Мб/с    |    4,8 Мб/с    |        207 Гб/сут         |
| 10 | Удаление сообщения              |    28 Кб/с     |    56 Кб/с     |        2,4 Гб/сут         |
| 11 | Просмотр сообщений              |    17 Мб/с     |    34 Мб/с     |        1,5 Мб/сут         |
| 12 | Просмотр голосовых сообщений    |    248 Мб/с    |    496 Мб/с    |         21 Тб/сут         |
| 13 | Просмотр сообщений с вложениями |    31 Гб/с     |    62 Гб/с     |        2,7 Пб/сут         |
| 14 | Получение списка диалогов       |    1,1 Мб/с    |    2,2 Мб/с    |         95 Гб/сут         |
| 15 | Создание постов                 |    65 Гб/с     |    130 Гб/с    |        5,6 Пб/сут         |
| 16 | Просмотр ленты                  |    155 Гб/с    |    310 Гб/с    |         13 Пб/сут         |
| 17 | Просмотр поста                  |    22 Гб/с     |    44 Гб/с     |        1,9 Пб/сут         |
| 18 | Создание комментариев           |    8,8 Мб/с    |   17,6 Мб/с    |        760 Гб/сут         |
| 19 | Просмотр комментариев           |    600 Кб/с    |   1200 Кб/с    |         52 Гб/сут         |
| 20 | Поход за статикой               |    27 Мб/с     |    54 Мб/с     |        2,3 Тб/сут         |
