...
В роли основной БД выступает MongoDB. Данные в ней хранятся не в реляционном формате, а в виде документов в формате json, что делает её крайне гибкой и упрощает адаптацию к требованиям.
