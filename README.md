...
Внутри одного датацентра можно использовать BGP-балансировку, что уменьшит трафик на каждый сервер, но 
потребует специального размещения оборудования. Оно должно быть размещено симметрично с точки зрения сетевой топологии.
